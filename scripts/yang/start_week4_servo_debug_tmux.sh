...
STALE_TIMEOUT="${STALE_TIMEOUT:-1.5}"
SOURCE_STALE_TIMEOUT="${SOURCE_STALE_TIMEOUT:-6.0}"
DROPOUT_HOLD_DURATION="${DROPOUT_HOLD_DURATION:-1.5}"
PRE_ACTION_HOME_DURATION="${PRE_ACTION_HOME_DURATION:-0.0}"
